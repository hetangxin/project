...
<div id="box">
    <div id="foot">
        <table>
            ...
            <c:forEach items="${searchOrder}" var="order" varStatus="orderStatus">
                <tr class="tr1" >
                    <td colspan="7"><input type="checkbox"> &nbsp;&nbsp;订单号：${order.getOrderId()}</td>
                    <td align="center" rowspan="2"><a href="javascript:void(0);" onclick="deleteOrder(${order.getOrderId()})">删除</a></td>
                </tr>
                <tr align="center">
                    <td align="left">
                        <a href="${pageContext.request.contextPath}/book/${order.getBookId()}" target="_blank"><span class="imgs"><img class="imgstyle" src="<%=request.getContextPath()%>/img/book/${order.getBookImg()}.jpg" ></span></a>
...
<script type="text/javascript">
    ...
    function deleteOrder(id) {
        ...
        if(r){
            ...
            var path = "${pageContext.request.contextPath}/order/deleteOrder/s";
