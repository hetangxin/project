...
<div class="login-dark" style="background-image:url(&quot;${pageContext.request.contextPath}/static/img/star-sky.jpg&quot;);height:744px;">
    <form method="post" style="background-color:rgba(255,255,255,0.37);">
        <h2 class="sr-only">Login Form</h2>
        <div class="illustration">
            <i class="icon ion-ios-locked-outline" style="color:rgb(239,41,65);"></i>
        </div>
        <input class="form-control" type="text" name="adminId" placeholder="adminId" id="adminId">
        <input class="form-control" type="password" name="adminPassword" placeholder="Password" id="adminPassword">
        <button class="btn btn-primary btn-block" type="button" data-bs-hover-animate="pulse" id="adminLogin" style="background-color:rgb(239,41,65);">登录</button>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#adminLogin").click(function () {
            ...
            var adminid2 = "admin";
            var adminpassword2 = "1234";

            if(adminid != adminid2 || adminpassword != adminpassword2) {
                $("#errorInfo").css("color", "rgb(220, 53, 69)");
                $("#errorInfo").html("输入的账号密码不正确！！！");
                return false;
            }
