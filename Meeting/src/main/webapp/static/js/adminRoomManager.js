...
$(document).ready(function () {
  ...
  /* $.ajax(settings).done(function (response) {
    ...
    var $pager = $('<div style="width: 100px;height: 100px;margin-left: 100px;" class="page"></div>');  //新建div，放入a标签,显示底部分页码
    for (var pageIndex = 0; pageIndex < sumPages; pageIndex++) {
      $('<a href="#" id="pageStyle" style="margin-left:100px;" onclick="changCss(this)"><span>' + (pageIndex + 1) + '</span></a>').bind("click", { "newPage": pageIndex }, function (event) {
...
$("#addtables").on('click', "button[name='addm']", function () {
  ...
  $("#alterMeetingRoomName").val(ss.eq(0).html());
  $("#alterFloor").val(ss.eq(1).html());
  $("#alterRoomNumber").val(ss.eq(2).html());
  $("#alterCapacity").val(ss.eq(3).html());   //$("#department").find("option[value="+dep+"]").attr("selected",true);
...
//   var ll = "";
//   $("input[type='checkbox'][name='xuan']:checked").each(function () {
